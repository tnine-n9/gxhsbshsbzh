...
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/tnine-n9/gxhsbshsbzh/refs/heads/main/91library.lua"))()
         
local win = ui:new("tnine")
--
...
local about = UITab355:section("『通用』",true)
    
about:Textbox("快速跑步（死后重置）", "tpwalking", "输入", function(king)
local tspeed = king
